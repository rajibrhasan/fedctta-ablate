...
exp_args = dict(
    data=dict(dataset='imagenet', data_path='./data/imagenet', sample_method=dict(name='iid', train_num=50000, test_num=500),
    ...
    group=dict(name='adapt_group', aggregation_method='base',
