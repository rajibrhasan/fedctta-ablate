...
@CLIENT_REGISTRY.register('fedctta_client')
class FedCTTAClient(ClientTemplate):

    def __init__(self, args: dict, client_id: int, train_dataset: Iterable = None, test_dataset: Iterable = None):
        super(FedCTTAClient, self).__init__(args, client_id, train_dataset, test_dataset)
        self.args = args
    ...
    def adapt(self, test_data, device=None, ap=0.72, mt=0.999, rst=0.01):
        ...
        for eps in range(1):
            ...
            for _, data in enumerate(self.adapt_loader):
                ...
                # # Student update
                outputs_ema = self.model_ema(batch_x)
