...
class ResNet(nn.Module):
    def __init__(
        ...
        self.fc = nn.Linear(512 * block.expansion, class_number)
...
@MODEL_REGISTRY.register('imagenet_resnet18')
def imagenet_resnet18(**kwargs: Any) -> ResNet:
    return _resnet(BasicBlock, [2, 2, 2, 2], **kwargs)

@MODEL_REGISTRY.register('imagenet_resnet50')
def imagenet_resnet50(**kwargs: Any) -> ResNet:
